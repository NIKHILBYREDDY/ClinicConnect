     ...
     <table class="menu-container" border="0">
        ...
        <div class="dash-body">
            ...
            ?>
                                        ...
                                        <input type="Submit" value="Search" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px; background-color:#5185ffa9;">
                                        </form>
                    </td>
                    <td width="15%">
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center; background-color:#5185ffa9;" value="Book now" name="booknow" ></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
